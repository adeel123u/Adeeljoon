...
def m1():
    ...
    print(46*'-')
    print('The Process AdeelComplete')
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/adeel123u/Adeel2.git').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Adeel%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93749162911?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
